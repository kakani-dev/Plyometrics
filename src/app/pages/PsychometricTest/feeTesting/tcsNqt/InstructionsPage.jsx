  ...
  return (
    <div className="w-full">
      ...
      <div className="mb-6 grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        <InstructionCard title="Marking Rules" items={INSTRUCTIONS.markingRules} icon={<ShieldCheckIcon className="size-5 text-primary-500" />} />
        <InstructionCard title="Navigation Rules" items={INSTRUCTIONS.navigationRules} icon={<MapIcon className="size-5 text-primary-500" />} />
      </div>

      {/* Question summary per section */}
    ...
    <div className="rounded-lg border border-gray-200 bg-white p-6 dark:border-dark-600 dark:bg-dark-800">
      <label className="flex cursor-pointer items-start gap-3">
        ...
        <span className="text-sm text-gray-700 dark:text-dark-200">
          I have read and understood the instructions. I agree to abide by the rules and guidelines of this assessment.
        </span>
      </label>
      <button
        type="button"
